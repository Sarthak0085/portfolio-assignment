...
const ContactForm = () => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      ref={form}
      className="mt-12 text-xl gap-2 text-black dark:text-white font-medium loading-relaxed "
    >
      Hello, My name is
      <input
        type="text"
      ...
      <input
        ...
        className="mt-8 font-medium inline-block capitalize text-xl py-3 px-8 border-2 border-[#55e6a5] 
              rounded-md cursor-pointer hover:bg-[#55e6a5] text-black dark:text-white"
      />
      <div className="mx-[1rem] flex items-center pb-6 pt-8" aria-hidden="true">
        <div className="flex-grow border-t border-slate-800 dark:border-gray-100" />
